...
from preprocessing.embeddings import prepare_embeddings, merge_embeddings, prepare_arabic_embeddings, \
    prepare_spanish_embeddings
from utility.commons.languages import Language


def run_lstm_benchmark(train_df, test_df, sent_cols, sim_col, validation_portion=0.1, n_hidden=100,
